...
$files = scandir("./");
//print_r($files);
$dontShow = array("12spanBootstrap", ".", "..", "index.old.html", "compare.old.php", "compareResults.old.php", "single.old.php", "phplogger.old.php", "compare.php", "compareResults.php", "index.html", "phplogger.php", "single.php", "static", "62.csv", "day2");
