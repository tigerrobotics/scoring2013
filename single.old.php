...
if (T3Pt.length == favoriteGoal) {favoriteGoal = 3; var favoriteGoalAccuracyPercentage = (T3Pt.length/(T3Pt.length+T0Pt.length))*100; var favoriteGoalArray = T3Pt;}
if (T2Pt.length == favoriteGoal) {favoriteGoal = 2; var favoriteGoalAccuracyPercentage = (T2Pt.length/(T2Pt.length+T0Pt.length))*100; var favoriteGoalArray = T2Pt;}
if (T1Pt.length == favoriteGoal) {favoriteGoal = 1; var favoriteGoalAccuracyPercentage = (T1Pt.length/(T1Pt.length+T0Pt.length))*100; var favoriteGoalArray = T1Pt;}
...
climbingPointsOverTime.push(dunkPoints+climbingPointsOverTime[134]);
document.write(dunkPoints+ parseInt(climbingPointsOverTime[134]));
