...
<form id="teamForm" method="GET" action="http://slidell-robotics.com/loggingdata/compareResultsDay2.php">
        <button class="btn btn-success" type="submit">Compare Teams!</button>

        <h4>*Resulting page designed for mobile landscape window.</h4>
